...
@EnableJpaRepositories(basePackages = { "com.jspxcms.core.repository",
        "com.jspxcms.ext.repository" }, repositoryFactoryBeanClass = MyJpaRepositoryFactoryBean.class)
...
public class ContextConfig {
     ...
     * @return
     */
    @Bean(name = "aliyunSMSUtils")
    public AliyunSMSUtils aliyunSMSUtils() {
       return  new AliyunSMSUtils(accessKeyId, accessKeySecret);
    }
