...
public class AliyunSMSUtils {
    ...
    public SendSmsResponse sendSMS_125116385(String phone, String name, String from, String content) {
        ...
        request.setSignName("国政教育");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_130929001");
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
    ...
    public SendSmsResponse sendSms(String phone, String message) {
        ...
        request.setTemplateParam("{\"customer\":\""+message+"\"}");
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        if(response.getCode() != null && response.getCode().equals("OK")) {
            QuerySendDetailsResponse querySendDetailsResponse = smsUtils.querySendDetails(response.getBizId());
