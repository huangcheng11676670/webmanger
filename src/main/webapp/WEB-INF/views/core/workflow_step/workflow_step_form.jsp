...
<div class="content">
    <div class="box box-primary">
        <form class="form-horizontal" id="validForm" action="${oprt=='edit' ? 'update' : 'save'}.do" method="post">
            ...
            <f:hidden name="workflowId" value="${workflowId}" />
            ...
            <div class="box-header with-border">
                <div class="btn-toolbar">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-default" type="button" onclick="location.href='list.do?workflowId=${workflowId}';"><s:message code="return"/></button>
                    </div>
                </div>
            </div>
            <div class="box-body">
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <s:message code="workflowStep.name" /></label>
                        <div class="col-sm-10">
             ...
             <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><em class="required">*</em>
                        <s:message code="workflowStep.roles" /></label>
                        <div class="col-sm-10">
                           <f:checkboxes labelClass="checkbox-inline" name="roleIds" items="${roleList}" checked="${bean.roles}" itemLabel="name" itemValue="id"/>
                        </div>
                    </div>
                </div>
            </div>
