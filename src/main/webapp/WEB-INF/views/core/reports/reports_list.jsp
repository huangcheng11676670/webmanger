            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form class="form-inline">
                        ...
                        <div class="form-group">
                        <input class="form-control input-sm" type="text"  id="search_createTime_Date" onclick="WdatePicker({dateFmt:'yyyy-MM-dd', maxDate:'#F{$dp.$D(\'search_endTime_Date\')}'});" />
                        至<input class="form-control input-sm" type="text" id="search_endTime_Date" onclick="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'#F{$dp.$D(\'search_createTime_Date\')}'});"/>
                        </div>
