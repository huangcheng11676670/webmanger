...
<body class="skin-blue content-body">
    ...
    <div class="content">
        <ul class="nav nav-tabs">
          ...
          <li role="presentation" class="active"><a href="#">监测员数据</a></li>
            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form class="form-inline">
                        ...
                        <h3 class="box-title">监测员数据</h3>
                        </div>
                        <div class="form-group">
                        <select class="form-control input-sm" id="userId_select_bar">
...
function searchReport_bar() {
    $.getJSON("user_bar_data.do", {userId : $("#userId_select_bar").val(), startDate: $("#search_createTime_Date_bar").val() ,  endDate : $("#search_endTime_Date_bar").val() }, function(json){
         if(json.status){
