    ...
    <div class="content">
        <div class="box box-primary">
            <form class="form-horizontal" id="validForm"
                action="${oprt=='edit' ? 'update' : 'save'}.do"
                method="post">
                <tags:search_params />
                    ...
                    <div class="btn-toolbar">
                        <div class="btn-group">
                            <shiro:hasPermission name="core:org:create">
                                <button class="btn btn-default"
                                    type="button"
                                    onclick="location.href='create.do?parentId=${parent.id}&${searchstring}';"
                        ...
                        <div class="btn-group">
                            <shiro:hasPermission name="core:org:copy">
                                <button class="btn btn-default"
                                    type="button"
                                    onclick="location.href='create.do?id=${bean.id}&${searchstring}';"
                                    <c:if test="${oprt=='create'}"> disabled="disabled"</c:if>>
                                    <s:message code="copy" />
                                </button>
                            </shiro:hasPermission>
                        ...
                        <div class="btn-group">
                            <button class="btn btn-default"
                                ...
                                <c:if test="${empty side.prev}"> disabled="disabled"</c:if>>
                                <s:message code="prev" />
                            </button>
                            <button class="btn btn-default"
                                type="button"
                                onclick="location.href='edit.do?id=${side.next.id}&position=${position+1}&${searchstring}';"
                                <c:if test="${empty side.next}"> disabled="disabled"</c:if>>
                                <s:message code="next" />
                            </button>
                        </div>
                        <div class="btn-group">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <c:choose>
                                        <c:when
                                            test="${orgTreeNumber eq bean.treeNumber}">
                                            <f:hidden id="parentId"
                                                name="parentId"
                                                value="${parent.id}" />
                                            <p
                                                class="form-control-static">${parentName}</p>
                                        </c:when>
                                        <c:otherwise>
                                            <f:hidden id="parentId"
                                                name="parentId"
        ...
        params : {
            ...
            "treeNumber" : "${orgTreeNumber}"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label"><em class="required">*</em>
                                <s:message code="org.name" /></label>
                                <div class="col-sm-8">
                                    <f:text name="name"
                                        value="${oprt=='edit' ? bean.name : ''}"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label"><em class="required">*</em>编码</label>
                                <div class="col-sm-8">
                                    <f:text name="number"
                                        value="${oprt=='edit' ? bean.number : ''}"
                                        class="form-control required"
                                        maxlength="100" />
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><s:message
                                        code="org.contacts" /></label>
                                <div class="col-sm-10">
                                    <f:text name="contacts"
                                        value="${oprt=='edit' ? bean.contacts : ''}"
                                        class="form-control"
                                        maxlength="100" />
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><s:message
                                        code="org.fullName" /></label>
                                <div class="col-sm-10">
                                    <f:text name="fullName"
                                        value="${oprt=='edit' ? bean.fullName : ''}"
                                        class="form-control"
                                        maxlength="100" />
                                </div>
                            </div>
