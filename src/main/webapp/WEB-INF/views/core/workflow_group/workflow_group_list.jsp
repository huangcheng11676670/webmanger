...
<div class="content-header">
    <h1>工作流分组 - <s:message code="list"/> <small>(<s:message code="totalElements" arguments="${pagedList.totalElements}"/>)</small></h1>
</div>
<div class="content">
        ...
        <div class="box-body table-responsive">
            <form class="form-inline ls-search" action="list.do" method="get">
                <div class="form-group">
                  <label>名称</label>
                  <f:text class="form-control input-sm" name="search_CONTAIN_name" value="${search_CONTAIN_title[0]}" style="width:180px;"/>
                </div>
            ...
            <form action="batch_update.do" method="post">
                ...
                <table id="pagedTable" class="table table-condensed table-bordered table-hover ls-tb">
                  ...
                  <tr class="ls_table_th">
                    ...
                    <th class="ls-th-sort"><span class="ls-sort" pagesort="seq">排序</span></th>
                  </tr>
                  </thead>
                  <tbody>
