...
<div class="content-header">
    <h1><s:message code="workflow.management"/> - <s:message code="list"/></h1>
</div>
<div class="content">
...
<%--                             <shiro:hasPermission name="core:workflow:delete">
                      ...
                      <shiro:hasPermission name="core:workflow_step:create">
                           <a id="edit_opt_${bean.id}" href="../workflow_step/list.do?workflowId=${bean.id}&${searchstring}" class="ls-opt"><s:message code="workflow.step"/></a>
                      </shiro:hasPermission>
                     </td>
                    ...
                    <td><s:message code="workflow.status.${bean.status}"/></td>
                  </tr>
                  </c:forEach>
                  </tbody>
                </table>
