    ...
    <div class="box box-primary">
        <form class="form-horizontal" id="validForm" action="${oprt=='edit' ? 'update' : 'save'}.do" method="post">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <s:message code="workflow.name" /></label>
                        <div class="col-sm-8">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="col-sm-4 control-label"><em class="required">*</em>
                        <s:message code="workflow.group" /></label>
                        <div class="col-sm-8">
                           <select class="form-control" name="groupId" >
                                 <f:options itemLabel="name" itemValue="id" selected="${bean.group}" items="${workflowGroupList}"/>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="col-sm-4 control-label"><s:message code="workflow.status" /></label>
                        <div class="col-sm-8">
                        <label class="radio-inline"><f:radio name="status" value="1" checked="${bean.status}" default="1" class="required" /><s:message code="workflow.status.1"/></label>
                        <label class="radio-inline"><f:radio name="status" value="2" checked="${bean.status}" class="required" /><s:message code="workflow.status.2"/></label>
                        </div>
                    </div>
                </div>
            </div>
